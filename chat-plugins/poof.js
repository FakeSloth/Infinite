const messages = [
	...
	"Naten2006 accidently kicked {{user}} from the server!",
	"became a fgt!",
	"fell in love with Sparkychild!",
	...
	"visited Naten's bedroom and never returned!",
	"was BLEGHED on by Fender!",
	"{{user}}: what is the most popular pokemon hair product? Oasisbot: loreal Paras",
	"{{user}}: what was wrong with the painting in the video game? Oasisbot: it had a low frame rate",
